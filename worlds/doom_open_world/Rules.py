...
if TYPE_CHECKING:
    from . import DOOMOpenWorldWorld
...
def set_rules(doom_open_world_world: "DOOMOpenWorldWorld", included_episodes, pro):
    player = doom_open_world_world.player
    multiworld = doom_open_world_world.multiworld
